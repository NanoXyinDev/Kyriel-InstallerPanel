    ...
    <div className="terminal overflow-hidden relative">
      <div className="terminal-header flex justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={copyLogs} className="text-gray-500 hover:text-white transition-colors p-1">
            <Copy className="w-3.5 h-3.5" />
          </button>
          {onClear && (
            <button onClick={onClear} className="text-gray-500 hover:text-red-400 transition-colors p-1">
      ...
      <div 
        ref={scrollRef}
        className="p-3 md:p-4 h-60 md:h-80 overflow-y-auto font-mono text-[11px] md:text-xs space-y-1"
      >
        {logs.length === 0 ? (
