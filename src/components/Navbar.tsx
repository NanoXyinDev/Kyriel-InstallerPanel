...
import { Terminal, Shield, LogOut, User, Zap, MessageCircle, Home, Wrench } from 'lucide-react'
  ...
  return (
    <>
              ...
              {navItems.map(item => (
                <Link
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all ${
                    isActive(item.href)
                      ? 'bg-kyriel-accent/20 text-kyriel-accent'
      ...
      <div className="mobile-nav lg:hidden">
        ...
        <button
          onClick={logout}
          className="flex flex-col items-center gap-1 py-1 px-3 rounded-lg text-gray-500"
        >
