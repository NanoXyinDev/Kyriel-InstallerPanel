...
export default function AntiInspect() {
  useEffect(() => {
    ...
    const detectDevTools = () => {
      ...
      if(wt || ht) document.body.innerHTML = '<div style="background:#000;color:#ff3366;font-family:monospace;text-align:center;padding:100px;font-size:20px">[ KYRIEL PROTECT ]<br>DevTools Detected.<br>Access Denied.</div>'
    }
