    ...
    <div className="min-h-screen bg-kyriel-dark safe-bottom">
      ...
      <main className="pt-16 lg:pt-20 pb-20 lg:pb-12 px-3 md:px-4 lg:px-8 max-w-7xl mx-auto">
        <div className="mb-4 md:mb-8">
          ...
          <p className="text-gray-500 text-xs md:text-sm">Deploy themes dengan sekali klik. VPS-ready.</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 mb-4 md:mb-8">
          <div className="bg-kyriel-card border border-white/5 rounded-xl p-3 md:p-5 card-hover">
            <div className="flex items-center justify-between mb-2 md:mb-3">
              <Zap className="w-4 h-4 md:w-5 md:h-5 text-kyriel-accent" />
              <span className="text-[10px] md:text-xs text-kyriel-success bg-kyriel-success/10 px-1.5 md:px-2 py-0.5 rounded">+12%</span>
            </div>
          ...
          <div className="bg-kyriel-card border border-white/5 rounded-xl p-3 md:p-5 card-hover">
            <div className="flex items-center justify-between mb-2 md:mb-3">
              ...
              <span className="text-[10px] md:text-xs text-kyriel-success bg-kyriel-success/10 px-1.5 md:px-2 py-0.5 rounded">+5%</span>
            </div>
          ...
          <div className="bg-kyriel-card border border-white/5 rounded-xl p-3 md:p-5 card-hover">
            <div className="flex items-center justify-between mb-2 md:mb-3">
              <Shield className="w-4 h-4 md:w-5 md:h-5 text-kyriel-success" />
              <span className="text-[10px] md:text-xs text-kyriel-success bg-kyriel-success/10 px-1.5 md:px-2 py-0.5 rounded">+8%</span>
            </div>
          ...
          <div className="bg-kyriel-card border border-white/5 rounded-xl p-3 md:p-5 card-hover">
            <div className="flex items-center justify-between mb-2 md:mb-3">
              <Clock className="w-4 h-4 md:w-5 md:h-5 text-kyriel-warning" />
              <span className="text-[10px] md:text-xs text-kyriel-success bg-kyriel-success/10 px-1.5 md:px-2 py-0.5 rounded">-15%</span>
            </div>
        ...
        <div className="bg-gradient-to-r from-kyriel-accent/10 to-kyriel-purple/10 border border-kyriel-accent/20 rounded-xl p-4 md:p-5 mb-4 md:mb-8 flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4">
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-kyriel-accent/20 flex items-center justify-center shrink-0">
            <Lock className="w-5 h-5 md:w-6 md:h-6 text-kyriel-accent" />
          </div>
          <div className="flex-1">
            <h3 className="font-bold text-white text-sm md:text-base mb-1">Anti-DDoS Protection Active</h3>
            <p className="text-xs md:text-sm text-gray-400">Semua install otomatis include protection layer. Rate limiting, WAF rules, dan Cloudflare integration siap.</p>
          </div>
          <div className="hidden sm:flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg bg-kyriel-success/10 border border-kyriel-success/30">
            ...
            <span className="text-xs md:text-sm text-kyriel-success font-mono">ACTIVE</span>
          </div>
        </div>
        ...
        <div className="mb-4 md:mb-8">
          <div className="flex items-center gap-2 mb-3 md:mb-4">
            ...
            <h2 className="text-lg md:text-xl font-bold">Theme Installer</h2>
          </div>
          <InstallPanel />
        </div>
